...
describe('release families', () => {
  it('excludes private experimental packages and deploy roots from the dsh release', () => {
    ...
    expect(members.map(member => member.directory)).not.toContain('apps/tauri')
    expect(members.map(member => member.directory)).not.toContain('apps/tauri-sidecar')
  })
