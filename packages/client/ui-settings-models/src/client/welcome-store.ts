 ...
 * the transport: production browsers follow the durable Host section, while
 * an explicitly memory-backed scope keeps the acknowledgement process-local.
 */
...
export class WelcomeNoticeStore {
  ...
  /**
   * Persist this copy version, or advance only this process for a memory-backed
