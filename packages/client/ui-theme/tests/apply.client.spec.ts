...
describe('ui-theme apply', () => {
  ...
  it('loads Host settings at boot and refreshes local and trusted remote browsers', async () => {
    const b = await bench()
    ...
    remote.ctx.remote.$dispatch('settings/document-updated', [THEME_SETTINGS_NAMESPACE, 0])
